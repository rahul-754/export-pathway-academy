...
import { Video, Clock, Star, Trophy, ArrowRight } from 'lucide-react';
            ...
            >
              <div className="aspect-video bg-gray-200 relative">
                ...
                <div className="absolute top-2 right-2">
                  <Badge className="bg-green-600">{course.level || 'General'}</Badge>
                </div>
              </div>

              <CardHeader className="space-y-1">
  <CardTitle className="text-xl truncate whitespace-nowrap overflow-hidden">{course.title}</CardTitle>
  <CardDescription className="text-sm truncate whitespace-nowrap overflow-hidden">{course.courseDescription}</CardDescription>
</CardHeader>
